...
////            if (product != null) {
////                productLiveData.setValue(product);
////                productImagesLiveData.setValue(product.getImages()); // Cập nhật danh sách ảnh
////                loadSimilarProducts(product.getCategoryId());
////            }
////        });
////
...
////    }
////
////    private void loadProductColors(String productId) {
////        productRepository.getProductColors(productId, colors -> {
...
////                }
////            } else {
////                // Fallback to default colors if none found in database
////                List<ColorItem> defaultColors = new ArrayList<>();
////                defaultColors.add(new ColorItem("1", "Beige", "#F5F5DC"));
////                defaultColors.add(new ColorItem("2", "Đen", "#000000"));
////                defaultColors.add(new ColorItem("3", "Đỏ", "#FF0000"));
////                colorsLiveData.setValue(defaultColors);
////            }
////        });
////    }
////
////    private void loadProductSizes(String productId, int productType) {
////        productRepository.getProductSizes(productId, sizes -> {
////            if (sizes != null && !sizes.isEmpty()) {
////                sizesLiveData.setValue(sizes);
////                // Set default selected size if none is selected
////                if (selectedSize.getValue() == null && !sizes.isEmpty()) {
////                    selectedSize.setValue(sizes.get(0).getName());
////                }
////            } else {
////                // Fallback to default sizes based on product type
////                sizesLiveData.setValue(getDefaultSizesForProductType(productType));
////            }
////        });
////    }
////
////    private List<SizeItem> getDefaultSizesForProductType(int productType) {
////        List<SizeItem> defaultSizes = new ArrayList<>();
////
////        switch (productType) {
////            case 1: // Clothing
...
////                break;
////            case 2: // Shoes
////                defaultSizes.add(new SizeItem("1", "36"));
////                defaultSizes.add(new SizeItem("2", "37"));
////                defaultSizes.add(new SizeItem("3", "38"));
////                defaultSizes.add(new SizeItem("4", "39"));
////                defaultSizes.add(new SizeItem("5", "40"));
////                defaultSizes.add(new SizeItem("6", "41"));
////                break;
////            default:
////                defaultSizes.add(new SizeItem("1", "S"));
////                defaultSizes.add(new SizeItem("2", "M"));
...
////    }
////
////    // Override setSelectedColor để cập nhật sizes khi color thay đổi
////    @Override
////    public void setSelectedColor(String color) {
////        selectedColor.setValue(color);
////
