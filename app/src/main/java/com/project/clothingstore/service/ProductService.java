...
//     Lay ra 5 san pham co luot ban cao nhat
    public void getSanPhamList(MutableLiveData<List<Product>> liveData) {
        CollectionReference productsRef = db.collection("products");

        // Lấy 5 sản phẩm có lượt bán cao nhất
        productsRef.orderBy("sold", Query.Direction.DESCENDING)
                .limit(5)
                .get()
...
//    }
    ...
    public void getListRecommentProduct(MutableLiveData<List<Product>> liveData) {
        CollectionReference productsRef = db.collection("products");

        // Lấy 5 sản phẩm có giảm gia cao nhất
        productsRef.orderBy("discount", Query.Direction.DESCENDING)
                .limit(5)
                .get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
...
//        List<Product> list = new ArrayList<>();
//        list.add(new Product("Áo hoodie trắng", 2090000, Arrays.asList("https://imgs.search.brave.com/MDZsD7FkUd4PtBeWW6KDOrz6LU9-QjPoA5SHxdhexN0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9idW1z/aG9wLmNvbS52bi93/cC1jb250ZW50L3Vw/bG9hZHMvMjAxOC8w/OS9tYXUtYW8taG9v/ZGllLWRlcC0yLmpw/ZWc")));
//        list.add(new Product("Áo phông", 3000000, Arrays.asList("https://imgs.search.brave.com/nVsiA9Sv8-fDMI2zukVEPuVshyxKwxmSQYijsAbcdLg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tY2Ru/LmNvb2xtYXRlLm1l/L2ltYWdlL0F1Z3Vz/dDIwMjIvYW8taW4t/aGluaF83NjkuanBn")));
//        list.add(new Product("Áo len", 3900000, Arrays.asList("https://imgs.search.brave.com/D2e42mhBDr38wRWcxwtQLjkjoJskWXMIXRyoOYSLUMI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9maWxl/LmhzdGF0aWMubmV0/LzEwMDAxNzg3Nzkv/ZmlsZS9hb19sZW5f/Y29fbG9fbnUuanBn")));
//        list.add(new Product("Áo dài", 450000, Arrays.asList("https://imgs.search.brave.com/NALIw-mSjKwuO0a0zIUbPIoxBcyF_cqYvoYRqlckWEI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90YWls/b2N3ZWRkaW5nLnZu/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDIz/LzA0L0FuaC1tYXUt/YW8tZGFpLXR1eWV0/LWRlcC01MzN4ODAw/LmpwZw")));
//        list.add(new Product("Đồ thể thao", 800000, Arrays.asList("https://imgs.search.brave.com/1Yylxm02DhkadoPI486UVUP3SqUPlgiPCoQMiJXVk5M/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9wcm9k/dWN0LmhzdGF0aWMu/bmV0LzIwMDAwMDI0/Nzk2OS9wcm9kdWN0/LzJfMGU0YzBjNTY4/YzY1NGIzNjliMDEx/ZDY1OGNkMWQ2Y2Vf/bGFyZ2UuanBn")));
//        return list;
//    }
